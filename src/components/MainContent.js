...
const MainContent = (props) => {
  return (
    <div className=" justify-content-center  p-0  d-flex">
      <Row className={`${mainContentClass.bgrond}  w-75 p-0`}>
        <Col className="p-0 text-start" xl={12} xxl={12} md={6}>
          <div>
            <img
              src={
        ...
        <Col className="text-start  text-light" xl={12} xxl={12} md={6}>
          <h4 className="pt-3 fw-bold">{props.allInfo.title.toUpperCase()}</h4>
          <p style={{ fontSize: "0.8em" }}>{props.allInfo.overview}</p>
          <Row>
            <Col xl={6} md={6} style={{ fontSize: "0.8em" }}>
              Original Release: <br />
